...
import { FiSearch, FiMapPin, FiBriefcase, FiFilter, FiDollarSign } from 'react-icons/fi';
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto' }}>
          ...
          <p style={{ 
            ...
            Discover opportunities that match your skills and career goals. Apply with a single click and track your applications seamlessly.
          </p>
        ...
        <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto' }}>
            ...
            {filteredInternships.map(internship => (
              ...
              >
                <div style={{ display: 'flex', gap: 'var(--space-md)', marginBottom: 'var(--space-md)' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: 'var(--font-size-lg)', fontWeight: 700, marginBottom: 4, lineHeight: 1.2 }}>
                      {internship.role}
                    </h3>
                    <div style={{ color: 'var(--color-muted)', fontSize: 'var(--font-size-sm)', fontWeight: 500 }}>
                      {internship.company}
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-sm)', marginBottom: 'var(--space-lg)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 'var(--font-size-xs)', color: 'var(--color-subtle)', background: 'var(--color-background)', padding: '4px 10px', borderRadius: 999 }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 'var(--space-xl)', flex: 1 }}>
          ...
          {filteredInternships.length === 0 && (
            <div style={{ textAlign: 'center', padding: 'var(--space-3xl) 0', color: 'var(--color-muted)' }}>
              <FiSearch size={48} style={{ opacity: 0.2, marginBottom: 'var(--space-md)' }} />
              <h3 style={{ fontSize: 'var(--font-size-lg)', fontWeight: 600, marginBottom: 8 }}>No internships found</h3>
