...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
      <path
        fill="#EA4335"
        d="M5.266 9.765A7.077 7.077 0 0 1 12 4.909c1.69 0 3.218.6 4.418 1.582L19.91 3C17.782 1.145 15.055 0 12 0 7.336 0 3.327 2.682 1.386 6.586L5.266 9.765z"
      />
      <path
        fill="#34A853"
        d="M16.04 15.345c-1.127.755-2.545 1.2-4.04 1.2a5.08 5.08 0 0 1-4.873-3.418l-3.9 3.018C5.127 19.89 8.327 22 12 22c2.973 0 5.673-1.018 7.69-2.782l-3.65-3.873z"
      />
      <path
        fill="#4285F4"
        d="M23.49 12.273c0-.818-.082-1.6-.218-2.363H12v4.51h6.46c-.29 1.48-1.145 2.736-2.42 3.563l3.65 3.873c2.136-1.973 3.8-4.882 3.8-8.582z"
      />
      <path
        fill="#FBBC05"
        d="M7.127 13.127A5.044 5.044 0 0 1 6.818 12c0-.39.064-.773.182-1.136L3.1 7.845A9.875 9.875 0 0 0 2 12c0 1.536.355 2.99 1.018 4.29l3.9-3.018z"
      />
    </svg>
  );
}
