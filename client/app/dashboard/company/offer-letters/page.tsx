...
export default function OfferLetterGenerator() {
  ...
  const templateContent = selectedApp
    ? `
Dear ${selectedApp.studentName},

We are thrilled to offer you the position of ${selectedApp.roleTitle} at ${customFields.companyName}. 
...
${customFields.responsibilities
  .split("\n")
  .map((r) => `• ${r}`)
  .join("\n")}

Benefits:
${customFields.benefits
  .split("\n")
  .map((b) => `• ${b}`)
  .join("\n")}
...
${customFields.companyName}
  `.trim()
    : "Please select a candidate to preview the offer letter.";
            ...
            <div style={{ display: "flex", gap: "var(--space-md)" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor:
                    generating || !selectedApplication
                      ? "not-allowed"
                      : "pointer",
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor:
                    generating || !generatedOfferId ? "not-allowed" : "pointer",
